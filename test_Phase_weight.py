...
if __name__ == "__main__":
    # 设置输入文件和输出目录
    pth_file = "output/fashion_mnist_models/fashion_mnist_epoch_100_20260409_163951.pth"  # Fashion-MNIST训练模型
    output_directory = "output/fashion_mnist_phase_layers"  # 输出目录
