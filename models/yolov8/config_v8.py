...
class ConfigYOLOv8Anchor:
    ...
    CLASS_NAMES = None
    NUM_CLASSES = None
    TEACHER_OUTPUT_DIR = r"output/OpticalTeacherYOLO_YOLOv8Head_Tv1_light_branch_slim_physical_privacy"
    LOG_ROOT_DIR = None
    LOG_FILE = None
    TIMESTAMP = None
    ...
    TEACHER_PHYSICAL_LOSS_WEIGHT = 0.05
    TEACHER_PHYSICAL_BLUR_KERNEL = 9
    TEACHER_PHYSICAL_TV_TARGET = 0.030
    TEACHER_PHYSICAL_HF_TARGET = 0.060
    TEACHER_PHYSICAL_RANGE_FLOOR = 0.35
    ...
    def apply_runtime_overrides(cls):
        overrides = {
            ...
            "OPTICAL_TEACHER_PHYSICAL_LOSS_WEIGHT": ("TEACHER_PHYSICAL_LOSS_WEIGHT", float),
            "OPTICAL_TEACHER_PHYSICAL_BLUR_KERNEL": ("TEACHER_PHYSICAL_BLUR_KERNEL", int),
            "OPTICAL_TEACHER_PHYSICAL_TV_TARGET": ("TEACHER_PHYSICAL_TV_TARGET", float),
            "OPTICAL_TEACHER_PHYSICAL_HF_TARGET": ("TEACHER_PHYSICAL_HF_TARGET", float),
            "OPTICAL_TEACHER_PHYSICAL_RANGE_FLOOR": ("TEACHER_PHYSICAL_RANGE_FLOOR", float),
