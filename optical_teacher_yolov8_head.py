"""CNN physical teacher training (V4 default, V2 baseline)."""
import argparse
...
def configure(args):
    Config.TEACHER_INIT_MODE = "scratch"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--experiment", choices=("dynamic-v4", "dynamic-v2"), default="dynamic-v4")
